package com.albo.pam.service.impl;
...
import com.albo.pam.dao.IPesajeSoaPamDAO;
import com.albo.pam.model.Pesaje;
import com.albo.pam.model.PesajePK;
import com.albo.pam.service.IPesajeSoaPamService;

@Service
public class PesajeSoaPamServiceImpl implements IPesajeSoaPamService {

	@Autowired
	private IPesajeSoaPamDAO pesajeSoaDao;
